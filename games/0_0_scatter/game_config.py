    ...
    def __init__(self):
        ...
        self.bet_modes = [
            BetMode(
                ...
                is_feature=True,
                is_buybonus=False,
                distributions=build_base_distributions(base_reel_weights, zero_quota=0.06, freegame_quota=0.18),
            ),
            BetMode(
                ...
                distributions=build_base_distributions(
                    bonus_hunt_reel_weights, zero_quota=0.05, freegame_quota=0.60
                ),
            ),
            BetMode(
